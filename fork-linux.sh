...
if ! [[ -d linux$version-tkg-bmq-raptorlake ]]; then
    cp -ar linux"$version" linux"$version"-tkg-bmq-raptorlake
    ln -sv linux"$version"-tkg-bmq-raptorlake linux"$version"-tkg-bmq-raptorlake-dbg
    ln -sv linux"$version"-tkg-bmq-raptorlake linux"$version"-tkg-bmq-raptorlake-headers
fi
...
sed -i "s|# Template file for|# -*- sh -*-\n# Template file for|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
sed -i "s|hostmakedepends|depends=\"hristoast-removed\"\nhostmakedepends|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
...
sed -i "s|^linux$version|linux$version-tkg-bmq-raptorlake|;s|'linux$version'|'linux$version-tkg-bmq-raptorlake'|" srcpkgs/linux"$version"-tkg-bmq-raptorlake/template
...
sed -i "s|}_|}-tkg-bmq-raptorlake_|" srcpkgs/linux"$version"-tkg-bmq-raptorlake/template
...
sed -i "s|pkgname=linux$version|pkgname=linux$version-tkg-bmq-raptorlake|" srcpkgs/linux"$version"-tkg-bmq-raptorlake/template
...
sed -i "s|maintainer=\".* <.*@.*>|maintainer=\"Hristos <me@hristos.co>|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
sed -i "s|series)\"|series with TKG patches)\"|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
sed -i "s|archs=\"x86_64\* i686\* aarch64\*\"|archs=\"x86_64\*\"|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
sed -i "s|\tsed -i -e \"s\|\^\\\(CONFIG|\t#sed -i -e \"s\|\^\\\(CONFIG|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-raptorlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
...
sed -i "s|CONFIG_LOCALVERSION=\"_1\"|CONFIG_LOCALVERSION=\"-tkg-bmq-raptorlake_1\"|" srcpkgs/linux"$version"-tkg-bmq-raptorlake/files/x86_64-dotconfig
...
rm -f srcpkgs/linux"$version"-tkg-bmq/files/i386-dotconfig \
   ...
   srcpkgs/linux"$version"-tkg-bmq-raptorlake/files/arm64-dotconfig \
   srcpkgs/linux"$version"-tkg-bmq-raptorlake/files/i386-dotconfig \
