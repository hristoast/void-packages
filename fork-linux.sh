...
sed -i "s|# Template file for|# -*- sh -*-\n# Template file for|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
sed -i "s|hostmakedepends|depends=\"hristoast-removed\"\nhostmakedepends|" srcpkgs/linux"$version"-tkg-bmq/template srcpkgs/linux"$version"-tkg-bmq-alderlake/template srcpkgs/linux"$version"-tkg-bmq-zen/template
